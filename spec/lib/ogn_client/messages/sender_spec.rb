...
describe OGNClient::Sender do
  ...
  it "must parse valid raw message without flight level" do
    raw = "FLRDF0A52>APRS,qAS,LSTB:/220132h4658.70N/00707.72Ez090/054/A=001424 !W37! id06DF0A52 +020fpm +0.0rot 55.2dB 0e -6.2kHz gps4x6 s6.01 h03 rDDACC4 hearD7EA hearDA95"
    subject = OGNClient::Message.parse raw
    subject.must_be_instance_of OGNClient::Sender
  ...
  it "must parse valid raw message without gps" do
    raw = "FLRDF0A52>APRS,qAS,LSTB:/220132h4658.70N/00707.72Ez090/054/A=001424 !W37! id06DF0A52 +020fpm +0.0rot FL001.03 55.2dB 0e -6.2kHz s6.01 h03 rDDACC4 hearD7EA hearDA95"
    subject = OGNClient::Message.parse raw
    subject.must_be_instance_of OGNClient::Sender
  ...
  it "must parse valid raw message without FLARM software version" do
    raw = "FLRDF0A52>APRS,qAS,LSTB:/220132h4658.70N/00707.72Ez090/054/A=001424 !W37! id06DF0A52 +020fpm +0.0rot FL001.03 55.2dB 0e -6.2kHz gps4x6 h03 rDDACC4 hearD7EA hearDA95"
    subject = OGNClient::Message.parse raw
    subject.must_be_instance_of OGNClient::Sender
  ...
  it "must parse valid raw message without FLARM hardware version" do
    raw = "FLRDF0A52>APRS,qAS,LSTB:/220132h4658.70N/00707.72Ez090/054/A=001424 !W37! id06DF0A52 +020fpm +0.0rot FL001.03 55.2dB 0e -6.2kHz gps4x6 s6.01 rDDACC4 hearD7EA hearDA95"
    subject = OGNClient::Message.parse raw
    subject.must_be_instance_of OGNClient::Sender
  ...
  it "must parse valid raw message of address type FLARM device without explicit FLARM ID" do
    raw = "FLRDF0A52>APRS,qAS,LSTB:/220132h4658.70N/00707.72Ez090/054/A=001424 !W37! id06DF0A52 +020fpm +0.0rot FL001.03 55.2dB 0e -6.2kHz gps4x6 s6.01 h03 hearD7EA hearDA95"
    subject = OGNClient::Message.parse raw
    subject.must_be_instance_of OGNClient::Sender
    subject.id.must_equal "DF0A52"
  ...
  it "must parse valid raw message of address type ICOA without explicit FLARM ID" do
    raw = "ICA4B43D6>APRS,qAS,LSTB:/220132h4658.70N/00707.72Ez090/054/A=001424 !W37! id0D4B43D6 +020fpm +0.0rot FL001.03 55.2dB 0e -6.2kHz gps4x6 s6.01 h03 hearD7EA hearDA95"
    subject = OGNClient::Message.parse raw
    subject.must_be_instance_of OGNClient::Sender
  ...
  it "must parse valid raw message of address type non-ICAO/FLARM without explicit FLARM ID" do
    raw = "OGN36581B>APRS,qAS,LSTB:/220132h4658.70N/00707.72Ez090/054/A=001424 !W37! id0736581B +020fpm +0.0rot FL001.03 55.2dB 0e -6.2kHz gps4x6 s6.01 h03 hearD7EA hearDA95"
    subject = OGNClient::Message.parse raw
    subject.must_be_instance_of OGNClient::Sender
  ...
  it "must parse valid raw message without proximity" do
    raw = "FLRDF0A52>APRS,qAS,LSTB:/220132h4658.70N/00707.72Ez090/054/A=001424 !W37! id06DF0A52 +020fpm +0.0rot FL001.03 55.2dB 0e -6.2kHz gps4x6 s6.01 h03 rDDACC4 "
    subject = OGNClient::Message.parse raw
    subject.must_be_instance_of OGNClient::Sender
